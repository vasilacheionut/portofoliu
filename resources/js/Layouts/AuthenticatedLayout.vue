...
<template>
    <div>
        ...
        >
                                ...
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <Link
                                            ...
                                            method="post"
                                            as="button"
                                            class="block w-full text-left px-4 py-2 text-sm leading-5 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-150 ease-in-out"
                                        >
                                            Log Out
                                        </Link>
                                    </template>
            ...
            <header
                class="bg-white shadow dark:bg-gray-800 border-b dark:border-gray-700"
                v-if="$slots.header"
            >
